                        ...
                        for(var j in json[dish_class])
                        {
                            (function(){
                                ...
                                $(add).bind("click",function(){
                                    ...
                                    if(!(name in add_json))
                                    {
                                        add_json[name] = {"num":1,"price":price,"img":$(this).parent().parent().siblings(".dish_img").attr("src")};
                                    }
                                ...
                                $(dish_num).bind("blur",function(){
                                    ...
                                    else
                                    {
                                        ...
                                        if(!(name in add_json))
                                        {
                                            add_json[name] ={"num":parseInt($(dish_num).val()),"price":price,"img":$(this).parent().parent().siblings(".dish_img").attr("src")} ;
...
function initcart(json)
{
    ...
    for(var o in table_json)
    {
        ...
        $(num2).attr({"type":"text","value":0,"class":"kitchen_num","onkeyup":"this.value=this.value.replace(/[^0-9]\\D*$/,'')","maxlength":"1","disabled":"disabled"});
        $(li).append($(name));
        $(li).append($(img));
        $(should).append($(num));
